...
div[class*="tabs-content"]{padding:0!important;}

[data-testid="stTabs"]{margin-top:0!important;}
/* Streamlit 기본 헤더/상단 여백 완전 제거 */
.stApp>[data-testid="stAppViewContainer"]>[data-testid="stVerticalBlock"]{gap:0!important;}
/* 탭 리스트 숨기기 */
...
.ax-topbar{background:var(--surface);border-bottom:1px solid var(--border);display:flex;align-items:center;padding:0 28px;height:52px;position:sticky;top:0;z-index:200;box-shadow:0 1px 3px rgba(0,0,0,.06);width:100%;}
...
.ax-main{padding:32px 40px 48px;max-width:1360px;margin:0 auto;}
